...
declare class PersonalityInsightsV3 extends BaseService {
     ...
     */
    profile(params: PersonalityInsightsV3.ProfileParams, callback?: PersonalityInsightsV3.Callback<PersonalityInsightsV3.Profile>): Promise<any> | void;
    /**
     * Get profile as csv.
     *
     * Generates a personality profile for the author of the input text. The service accepts a maximum of 20 MB of input
     ...
     * @returns {Promise<any>|void}
     */
    profileAsCsv(params: PersonalityInsightsV3.ProfileAsCsvParams, callback?: PersonalityInsightsV3.Callback<NodeJS.ReadableStream | FileObject | Buffer>): Promise<any> | void;
}
/*************************
 * interfaces
 ************************/
